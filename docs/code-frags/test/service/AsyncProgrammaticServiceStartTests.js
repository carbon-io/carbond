...
__(function() {
  module.exports = o.main({
    _type: testtube.Test,
    name: 'AsyncProgrammaticServiceStartTests',
    tests: [
      o({
        _type: carbond.test.ServiceTest,
        name: 'AsyncProgrammaticServiceStartServiceTests',
        service: _o('../../standalone-examples/ServiceAsyncProgrammaticServiceStartExample').myService,
        tests: [
          {
            reqSpec: {
              method: 'GET',
      ...
      o({
        ...
        setup: function() {
          this.mod = _o('../../standalone-examples/ServiceAsyncProgrammaticServiceStartExample')
