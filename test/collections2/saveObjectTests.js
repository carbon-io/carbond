      ...
      o({
        ...
        tests: [
          ...
          },
          {
            ...
            resSpec: {
              $property: {get: function() {return this.history.getResSpec('FailSaveObjectSchemaTest')}}
            }
          },
          {
            ...
            resSpec: {
              $property: {get: function() {return this.history.getResSpec('SuccessSaveObjectSchemaTest')}}
            }
          }
        ]
      }),
