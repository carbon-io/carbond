        ...
        tests: [
          o({
            ...
            doTest: function(context) {
              ...
              assert.deepEqual(collection.endpoints[`:${context.global.idParameter}`].put.responses[200], {
                statusCode: 200,
                description: 'foo bar baz',
                schema: {
                  type: 'object',
                  properties: {
                    [context.global.idParameter]: {type: 'string'},
                    foo: {type: 'string'}
                  },
                  required: [context.global.idParameter, 'foo'],
                  additionalProperties: false
                },
                headers: []
              })
              assert.deepEqual(collection.endpoints[`:${context.global.idParameter}`].put.responses[400], {
                statusCode: 400,
                description: 'foo bar baz',
