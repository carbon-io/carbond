  ...
  _generateEndpointOperationForInsertAndInsertObject: function() {
    if (this.supportsInsert || this.supportsInsertObject) {
      ...
      if (this.supportsInsert && this.supportsInsertObject) {
        ...
        config = {
          opConfig: {
            ...
            middleware: insertConfig.opConfig.middleware ||
                        insertObjectConfig.opConfig.middleware,
            redact: insertConfig.opConfig.redact ||
                    insertObjectConfig.opConfig.redact,
          },
          defaultResponses: defaultResponses
        }
      ...
      this.post = o({
        ...
        middleware: config.opConfig.middleware,
        redact: config.opConfig.redact,
