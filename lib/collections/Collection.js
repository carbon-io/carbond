...
var Collection = oo({
   ...
   * @readonly
   */
  RemoveConfigClass: _o('./RemoveConfig'),
   ...
   * @readonly
   */
  RemoveObjectConfigClass: _o('./RemoveObjectConfig'),
   ...
   * @param {carbond.collections.Collection.FindObjectConfig} -- The find object operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
