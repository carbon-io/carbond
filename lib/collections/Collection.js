    ...
    if (this.supportsInsert) {
      ...
      self.post = {
        ...
        service: function(req, res) {
          ...
          return self.insert(obj, { req: req, res: res })
        }
      }
    }
  },
  ...
  _generateEndpointOperationForFind: function() {
    if (this.supportsFind) {
      ...
      this.get = {
        ...
        service: function(req, res) {
          return self.find(req.parameters.query, { req: req, res: res })
        }
      }
    }
  },
      ...
      objectSubEndpoint.put = o({
        ...
        service: function(req, res) {
          ...
          if (body) {
            ...
            return self.saveObject(body, { req: req, res: res }) // XXX What happens if doc does not exist? Do we insert? 
          }
        }
      })
    }
  ...
  _generateEndpointOperationForFindObject: function() {
    if (this.supportsFindObject) {
      ...
      objectSubEndpoint.get = o({
        ...
        service: function(req, res) {
          return self.findObject(req.parameters[self.idPathParameter], { req: req, res: res })
        }
      })
    }
  },
      ...
      objectSubEndpoint.patch = o({
        ...
        service: function(req, res) { 
          ...
          if (body) {
            ...
            // XXX what happens if doc does not exist? Should be a 404, which should be thrown as an NotFoundError
            // by implementation of updateObject.
