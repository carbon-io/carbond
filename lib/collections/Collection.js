...
var CollectionInitError = require('../util/errors').CollectionInitError
...
var Collection = oo({
  ...
  _init: function() {
    try {
      ...
      this.setSanityCheckError(new CollectionInitError(e, this, this.path))
    }
    // call super *last*
  ...
  _validate: function() {
    if (this.schema) {
      this._validateSchemaHasId(this.schema)
    }
  },
