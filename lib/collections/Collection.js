...
var Collection = oo({
   ...
   * @param {carbond.collections.InsertConfig} -- The insert operation config
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.InsertObjectConfig} -- The insert object operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
   ...
   * @param {carbond.collections.Collection.InsertConfigClass} -- The insert operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   ...
   * @param {carbond.collections.Collection.InsertObjectConfigClass} -- The insert object
   *                                                                    operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.FindConfig} -- The find operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
  preFindOperation: function(config, req, res) {
    ...
    var limit = _.get(req.parameters, 'limit', config.pageSize)
    var ids = _.get(req.parameters, this.idParameter, [])
    if (!_.isArray(ids)) {
      ids = [ids]
    }
    if (!_.isNil(config.maxPageSize)) {
      limit = _.min([limit, config.maxPageSize])
    }
   ...
   * @param {carbond.collections.Collection.FindConfig} -- The find operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
  ...
  _generateEndpointOperationForFind: function() {
    if (this.supportsFind) {
      ...
      this.get = _.assign(_.clone(operation), {
        responses: this._makeResponses(
      ...
      if (config.opConfig.supportsHead) {
        this.head = _.assign(_.clone(operation), {
          responses: this._makeResponses(
            'head', config.opConfig, config.defaultResponses, false),
          service: function(req, res) {
            find(req, res)
            return null
          }
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.FindObjectConfig} -- The find object operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
  ...
  _generateEndpointOperationForFindObject: function() {
    if (this.supportsFindObject) {
      ...
      var findObject = function(req, res) {
      ...
      objectSubEndpoint.get = o(
        _.assign(
          ...
          _.clone(operation),
          {
            ...
            service: function(req, res) {
              return findObject(req, res)
            }
          }
        )
      )

      if (config.supportsHead) {
        objectSubEndpoint.head = o(
          _.assign(
            {_type: '../Operation'},
            _.clone(operation),
            {
              responses: this._makeResponses(
                'headObject', config.opConfig, config.defaultResponses, false),
              service: function(req, res) {
                findObject(req, res)
                return null
              }
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.SaveConfig} -- The save operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
   ...
   * @param {carbond.collections.Collection.SaveConfig} -- The save operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.SaveObjectConfig} -- The save object operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
  preSaveObjectOperation: function(config, req, res) {
    if (req.parameters[this.idPathParameter] !== req.parameters.object[this.idParameter].toString()) {
      throw new this.service.errors.BadRequest(
   ...
   *                                                                    replaced
   * @param {carbond.collections.Collection.SaveObjectConfigClass} -- The save object operation
   *                                                                  config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.UpdateConfig} -- The update operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
   ...
   *                                                                object(s)
   * @param {carbond.collections.Collection.UpdateConfigClass} -- The update operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.UpdateObjectConfig} -- The update object operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
   ...
   *                                                                      upserted object
   * @param {carbond.collections.Collection.UpdateObjectConfigClass} -- The update object operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {object} -- Returns {@link {n: NUMBER_OF_OBJECTS_UPDATED_OR_UPSERTED}} or the upserted
   *                      object
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.RemoveConfig} -- The remove operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
   ...
   * @param {carbond.collections.Collection.RemoveConfigClass} -- The remove operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   ...
   *              request and operation config. Note, in general, this should not need to be
   *              overridden or extended.
   * @param {carbond.collections.RemoveObjectConfig} -- The remove object operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
   * @returns {carbond.collections.Collection.PreOperationResult}
   */
   ...
   * @param {carbond.collections.Collection.RemoveObjectConfigClass} -- The remove object
   *                                                                    operation config
   * @param {carbond.Request} req -- The request object
   * @param {carbond.Response} res -- The response object
  ...
  _makeResponses: function(op, config, defaultResponses, validateResponseSchemasHaveId) {
    ...
    if ((_.intersection(['headObject', 'findObject', 'saveObject', 'updateObject', 'removeObject'], op)).length > 0) {
      if ((op.indexOf('saveObject') === -1 || !config.supportsInsert) &&
