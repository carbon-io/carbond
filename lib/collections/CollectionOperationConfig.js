...
module.exports = oo({
  ...
  _C: function() {
    /***************************************************************************
     * @property {string} [description] -- A brief description of operation
     */
    ...
    /***************************************************************************
     * @peroperty {string} idParameter -- The collection object id property name. Note, this
    ...
    /***************************************************************************
     * @peroperty {object.<string, carbond.OperationParameter>} parameters
     * @description Operation specific parameters (e.g., "skip", "limit"). These will be passed down
     *              to the operation handlers via the context parameter if they are not explicitly
     *              passed via another leading parameter (e.g., "id" and "update" for
     *              {@link carbond.collections.Collection.updateObject}). Note, this should generally
     *              be left alone by instances. Instead, use
     *              {@link carbond.collections.CollectionOperationConfig.additionalParameters}.
     */
    this.parameters = {}
    /***************************************************************************
     * @property {object.<string, carbond.OperationParameter>} additionalParameters
     * @description Any additional parameters that should be added to the collection parameters. These
     *              can override parameters configured via the
     *              {@link carbond.collections.CollectionOperationConfig.parameters}. Note, these will
     *              all end up being passed down to operation handlers via the "context" parameter.
     */
    this.additionalParameters = undefined
    /***************************************************************************
     * @property {carbond.OperationResponse[]} responses
    ...
    this.endpoint = null
    /***************************************************************************
     * @property {object} [options={}] -- Any options that should be passed down to the operation
     *                                    handler to be used by the underlying driver
     */
    this.options = {}
  },
