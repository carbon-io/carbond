...
module.exports = oo({
   ...
   * @description ApiKeyAuthenticator description
   * @memberof carbond.security
   * @extends carbond.security.Authenticator
   */
  _C: function() {
    /***************************************************************************
     * @property {string} [apiKeyParameterName=Api-Key] -- xxx
     */
    this.apiKeyParameterName = "Api-Key"

    /***************************************************************************
     * @property {string} [apiKeyLocation=header] -- xxx
     */
    this.apiKeyLocation = "header" // can be "header" or "query"

    /***************************************************************************
     * @property {xxx} maskUserObjectKeys -- xxx
     */
    this.maskUserObjectKeys = undefined

    /***************************************************************************
     * @property {carbond.UUIDGenerator} idGenerator -- xxx
     */
    this.idGenerator = o({
      _type: UUIDGenerator
    })
   ...
   * @description _maskUserObject description
   * @param {xxx} user -- xxx
   * @returns {xxx} -- xxx
   */
   ...
   * @description generateApiKey description
   * @returns {xxx} -- xxx
   */
