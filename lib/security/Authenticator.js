...
module.exports = oo({
   ...
   *              {@link prop:carbond.security.ApiKeyAuthenticator}. Must be implemented
   *              by subclasses which use headers other than the Authorization header.
   *              Otherwise the custom headers will be blocked by the Service.
