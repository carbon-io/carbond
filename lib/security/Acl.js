...
module.exports = oo({
  ...
  /*****************************************************************************
   * @constructs Acl
   * @description Acl class description
   ...
   * @description _entriesGrantPermission description
   * @param {xxx} entries -- xxx
   * @param {xxx} user -- xxx
   * @param {xxx} permission -- xxx
   * @param {xxx} env -- xxx
   * @returns {xxx} -- xxx
   ...
   * @description _userMatchesSpec description
   * @param {xxx} user -- xxx
   * @param {xxx} spec -- xxx
   * @returns {xxx} -- xxx
   */
   ...
   * @description _getUserPropertyValue
   * @param {xxx} user -- xxx
   * @param {xxx} extractor -- xxx
   * @returns {xxx} -- xxx
   */
   ...
   * @description _checkPermission description
   * @param {xxx} user -- xxx
   * @param {xxx} aclEntry -- xxx
   * @param {xxx} permission -- xxx
   * @param {xxx} env -- xxx
   * @returns {xxx} -- xxx
   */
   ...
   * @description _checkPermissionPredicate description
   * @param {xxx} user -- xxx
   * @param {xxx} aclEntry -- xxx
   * @param {xxx} p -- xxx
   * @param {xxx} env -- xxx
