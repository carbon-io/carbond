...
module.exports = oo({
   ...
   * andBelow
   * 
   * ACL that combines this ACL with another in a parent-child relationship.  In such a relationship, if the child ACL
   * is not present, the parent (this) applies on its own.  If both exist, they are and()'ed together.
   */
  andBelow: function(childAcl) {
    return childAcl ? and(childAcl) : this
  },
