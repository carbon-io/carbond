...
module.exports = oo({
  ...
  _C: function() {
    ...
    /***************************************************************************
     * @property {string} [userCollection=undefined] -- The name of the collection
     *                                                  in which users are stored
     */
    this.userCollection = undefined

    /***************************************************************************
     * @property {string} [apiKeyField=undefined] -- The name of the field where
   ...
   *                                 database defined in
   *                                 {@link prop:carbond.security.MongoDBAuthenticator.dbName}
   */
  db: {
    $property: {
      get: function() {
