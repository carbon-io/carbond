...
module.exports = oo({
   ...
   */
  _type: './Authenticator',
  _ctorName: 'HttpBasicAuthenticator',
  ...
  _C: function() {
     ...
     *                                                      and *bcrypt*), an instance of
     *                                                      {@link class:carbond.security.Hasher} or
     *                                                      a constructor function for a
     *                                                      {@link class:carbond.security.Hasher}.
     */
   ...
   *              a user object that matches the username and password sent with
