...
module.exports = oo({
   ...
   */
  _C: function() {
    // TODO do we need a maxFindLimit?
    this.enabled = { '*' : true }
  ...
  _init: function() {
    ...
    this._initializeEndpoints() // XXX terrible name
...
/* Abstract interface
  ...
  update: function(options, update, options, reqCtx) {},
...
CollectionOperation
  ...
  - schema (optional -- for insert, update, updateObject, saveObject)
  - options
    - name 
    - description
    - schema
