...
module.exports = oo({
  ...
  /**********************************************************************
   * supportsCollectionRead
   */        
  supportsCollectionRead: true,

  /**********************************************************************
   * supportsCollectionInsert
   */        
  supportsCollectionInsert: true,

  /**********************************************************************
   * supportsCollectionUpdate
   */        
  supportsCollectionUpdate: true,

  /**********************************************************************
   * supportsCollectionDelete
   */        
  supportsCollectionDelete: true,

  /**********************************************************************
   * supportsObjectCreate // XXX future CREATE method?
   */        
   ...
   * supportsObjectRead
   */        
  supportsObjectRead: true,

  /**********************************************************************
   * supportsObjectUpdate
   */        
  supportsObjectUpdate: true,

  /**********************************************************************
   * supportsObjectDelete
   */        
  supportsObjectDelete: true,
