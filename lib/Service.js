...
var TooBusyLimiter = require('./security/Limiter').TooBusyLimiter
...
module.exports = oo({
 ...
 /**********************************************************************
  ...
  _initializeBusyLimiter: function(app) {
    ...
    if (_.isObjectLike(this.busyLimiter) && !(this.busyLimiter instanceof TooBusyLimiter)) {
      this.busyLimiter = o(this.busyLimiter, TooBusyLimiter)
    }
    this.busyLimiter.initialize(this)
