...
module.exports = oo({
  ...
  _C: function() {
    ...
    this.defaultBusyLimiterClass = _o('./security/Limiter').TooBusyLimiter
    this.lmiter = undefined
  },
 ...
 /**********************************************************************
  ...
  _initializeBusyLimiter: function(app) {
    ...
    if (_.isObjectLike(this.busyLimiter) && !(this.busyLimiter instanceof _o('./security/Limiter').Limiter)) {
