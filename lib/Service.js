...
module.exports = oo({
  ...
  _C: function() {
    ...
    this._signals = ["SIGHUP", "SIGINT", "SIGQUIT", "SIGABRT", "SIGTERM"] // XXX is this the right set?
   ...
   * _ignoreSignals
   */
  _ignoreSignals: function() {
    var self = this
    self._signals.forEach(function(signal) {
      process.once(signal, function() {
        self.logInfo('Ignoring signal ' + signal)
      })
    })
  },
