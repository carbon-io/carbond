...
var Service = oo({
  ...
  _C: function() {
    /***************************************************************************
     * @property {object} cmdargs -- xxx
     */ 
    this.cmdargs = {}

    // core
    /***************************************************************************
     * @property {string} [hostname=0.0.0.0] -- xxx
     */
    this.hostname = '0.0.0.0' // XXX: this should probably be 127.0.0.1

    /***************************************************************************
     * @property {number} [port=8888] -- xxx
     */
    this.port = 8888

    /***************************************************************************
     * @property {string} [description=This is a Service] -- xxx
     */
    this.description = "This is a Service"

    /***************************************************************************
     * @property {string} [verbosity=info] -- xxx
     */
    ...
    /***************************************************************************
     * @property {xxx} processUser -- xxx
     */
    this.processUser = undefined

    // Mount points
    /***************************************************************************
     * @property {xxx} apiRoot -- xxx
     */
    this.apiRoot = undefined

    /***************************************************************************
     * @property {string} [adminRoot=/service-admin] -- xxx
     */
    this.adminRoot = "/service-admin"

    // db config
    /***************************************************************************
     * @property {string} dbUri -- xxx
     */
    this.dbUri = undefined

    /***************************************************************************
     * @property {object} dbUris -- xxx
     */
    this.dbUris = {}
    ...
    /***************************************************************************
     * @property {object} dbs -- xxx
     */
    this.dbs = {}

    // endpoints
    /***************************************************************************
     * @property {object} endpoints -- xxx
     */
    this.endpoints = {}

    // authenticator
    /***************************************************************************
     * @property {xxx} authenticator -- xxx
     */
    this.authenticator = undefined

    // server and express
    /***************************************************************************
     * @property {xxx} _server -- xxx
     */
    this._server = undefined

    /***************************************************************************
     * @property {xxx} _expressApp -- xxx
     */
    this._expressApp = undefined

    /***************************************************************************
     * @property {xxx} middleware -- xxx
     */
    this.middleware = []

    /***************************************************************************
     * @property {xxx} errorHandlingMiddleware -- xxx
     */
    this.errorHandlingMiddleware = []

    /***************************************************************************
     * @property {xxx} publicDirectories -- xxx
     */
    this.publicDirectories = {}

    /***************************************************************************
     * @property {boolean} [corsEnabled=true] -- xxx
     */
    this.corsEnabled = true

    /***************************************************************************
     * @property {boolean} [_stopping=false] -- xxx
     */
    this._stopping = false

    /***************************************************************************
     * @property {boolean} [_stopped=false] -- xxx
     */
    this._stopped = false
    ...
    // events
    /***************************************************************************
     * @property {xxx} _eventEmitter -- xxx
     */
    ...
    // ssl
    /***************************************************************************
     * @property {xxx} sslOptions -- xxx
     */
    this.sslOptions = o({ _type: './SslOptions' })

    /***************************************************************************
     * @property {xxx} parameterParser -- xxx
     */
    this.parameterParser = o({ _type: "./ParameterParser" })

    // swagger / docs
    /***************************************************************************
     * @property {boolean} [generateOptionsMethodsInDocs=false] -- xxx
     */
    this.generateOptionsMethodsInDocs = false

    /***************************************************************************
     * @property {xxx} defaultDocgenOptions -- xxx
     */
    ...
    // logging
    /***************************************************************************
     * @property {xxx} _swaggerDescriptorGenerator -- xxx
     */ 
    this._swaggerDescriptorGenerator = o({_type: './SwaggerDescriptorGenerator'})

    // cluster
    /***************************************************************************
     * @property {boolean} [cluster=false] -- xxx
     */
    this.cluster = false

    /***************************************************************************
     * @property {number} numClusterWorkers -- xxx
     */
    this.numClusterWorkers = undefined

    /***************************************************************************
     * @property {xxx} _workers -- xxx
     */
    this._workers = undefined

    // limiters
    /***************************************************************************
     * @property {xxx} busyLimiter -- xxx
     */
    this.busyLimiter = undefined

    /***************************************************************************
     * @property {carbond.limiter.TooBusyLimiter} defaultBusyLimiterClass -- xxx
     */
    ...
    // fibers
    /***************************************************************************
     * @property {number} fiberPoolSize -- xxx 
     */
    this.fiberPoolSize = fibers.getFiberPoolSize()

    // mode
    /***************************************************************************
     * @property {xxx} env -- xxx
     */
    this.env = DEFAULT_ENV

    // socket timeout/destruction
    /***************************************************************************
     * @property {string} [gracefulShutdown=production] -- xxx
     */
    this.gracefulShutdown = DEFAULT_ENV === 'production'

    /***************************************************************************
     * @property {xxx} serverSocketTimeout -- xxx
     */
   ...
   * @description _initializeCmdargs description
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeMainDispatcher description
   * @returns {undefined} -- undefined
   */
  ...
  /*****************************************************************************
   * errors
   * Is this a property? TODO
   */
  errors: HttpErrors,

  /*****************************************************************************
   * @property {string} serviceName -- xxx
   */
  serviceName: {
   ...
   * @description _configureLogger description
   * @param {string} verbosity -- xxx
   * @returns {undefined} -- undefined
   */
  ...
  /*****************************************************************************
   * @method logTrace
   * @description logTrace description
   * @returns {undefined} -- undefined
   */
  logTrace: function() {
  ...
  /*****************************************************************************
   * @method logDebug
   * @description logDebug description
   * @returns {undefined} -- undefined
   */
  logDebug: function() {
  ...
  /*****************************************************************************
   * @method logWarning
   * @description logWarning description
   * @returns {undefined} -- undefined
   */
  logWarning: function() {
  ...
  /*****************************************************************************
   * @method logFatal
   * @description logFatal description
   * @returns {undefined}  -- undefined
   */
  logFatal: function() {
  ...
  /*****************************************************************************
   * @method on
   * @description Register an event callback.
  ...
  /*****************************************************************************
   * @method once
   * @description Register an event callback that executes once.
  ...
  /*****************************************************************************
   * Remove all listeners. If `event` is passed, remove all events for that
   * specific event (or events).
   * @method removeAllListeners
   * @description Remove all listeners. If `event` is passed, remove all events for that
   *              specific event (or events).
   * @param {String} [event...] -- the event type [choices: "start", "stop"]
   * @returns {xxx} -- xxx
   */
  ...
  /*****************************************************************************
   * @method doStart
   * @description doStart description
   * @param {xxx} options -- xxx
   * @returns {undefined} -- undefined
   */
  ...
  /*****************************************************************************
   * @method _listen
   * @description _listen description
   * @param {Function} cb -- xxx
   * @returns {undefined} -- undefined
   */
  _listen: function(cb) {
   ...
   * @description _initializeSecureConnectionHandler description
   * @returns {undefined} -- undefined
   */
   ...
   * @description _ensureProcessUser
   * @returns {undefined} -- undefined
   */
  ...
  /*****************************************************************************
   * @method doStop
   * @description doStop description
   * @returns {undefined} -- undefined
   */
  doStop: function() {},
   ...
   * @description _authenticate description
   * @param {xxx} req -- xxx
   * @param {xxx} res -- xxx
   * @param {xxx} next -- xxx
   * @returns {xxx} -- xxx
   ...
   * @description _initializeDatabaseConnections description
   * @returns {xxx} -- xxx
   */
 ...
 /******************************************************************************
   ...
   * @description _closeDatabaseConnections description
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeBusyLimiter description
   * @param {xxx} app -- xxx
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeHttpServer description
   * @returns {xxx} -- xxx
   */
   ...
   * @description _initializeLimiterDescription
   ...
   * @description _initializeMiddleware description
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeErrorHandlingMiddleware description
   * @returns {undefined} -- undefined
   */
  ...
  /*****************************************************************************
   * @method _initalizeFiberMiddleware
   * @description _initalizeFiberMiddleware
   * @returns {undefined} -- undefined
   */
  ...
  /*****************************************************************************
   * @method _handleError
   * @description _handleError description
   * @param {xxx} err -- xxx
   * @param {xxx} res -- xxx
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeAuthenticator
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeCORSMiddleware
   * @param {xxx} endpoint -- xxx
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeStaticRoutes
   * @returns {xxx} -- xxx
   */
   ...
   * @description _initializeEndpoint description
   * @param {xxx} endpoint -- xxx
   * @param {xxx} path -- xxx
   * @param {xxx} parent -- xxx
   * @param {xxx} parentEndpointsPath -- xxx
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeEndpoints description
   * @param {xxx} endpoints -- xxx
   * @param {xxx} path -- xxx
   * @param {xxx} parent -- xxx
   * @param {xxx} parentEndpointsPath -- xxx
   * @returns {undefined} -- undefined
   ...
   * @description _defineExpressRoutesForEndpoint description
   * @param {xxx} app -- xxx
   * @param {xxx} endpoint -- xxx
   * @param {xxx} parentEndpointsPath -- xxx
   * @returns {undefined} -- undefined
   ...
   * @description _defineExpressRouteForOperation description 
   * @param {xxx} app -- xxx
   * @param {xxx} method -- xxx
   * @param {xxx} endpoint -- xxx
   * @param {xxx} operation -- xxx
   * @param {xxx} parentEndpointsPath -- xxx
   * @returns {undefined} -- undefined
   */
   ...
   * @description _makeOperationWrapper description
   * @param {xxx} operation -- xxx
   * @param {xxx} endpoint -- xxx
...
//      console.log(e.stack) // XXX this is not really ok -- need to know which type exception
   ...
   * @description Endpoint ACLs are used here to gate access to operations
   * @param {xxx} user -- xxx
   * @param {xxx} endpoint -- xxx
   * @param {xxx} method -- xxx
   * @param {xxx} req -- xxx
   ...
   * @description _secureMongoUriString description
   * @param {string} uri -- xxx
   * @returns {xxx} -- xxx
   */
