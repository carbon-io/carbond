...
var Service = oo({
  ...
  /*****************************************************************************
   * @method doStart
   * @description This method will be called after initialization (e.g., database
   *              connections will be established and the endpoint tree will be
   *              built) but before the server's socket is bound. Override this
   *              method if your app requires further initialization.
   * @param {Object} options -- Parsed command line options
   * @returns {undefined}
   */
