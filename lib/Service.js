...
module.exports = oo({
  ...
  _C: function() {
    ...
    this.defaultBusyLimiterClass = _o('./limiter/Limiter').TooBusyLimiter
 ...
 /**********************************************************************
  ...
  _initializeBusyLimiter: function(app) {
    ...
    if (_.isObjectLike(this.busyLimiter) && !(this.busyLimiter instanceof _o('./limiter/Limiter').Limiter)) {
