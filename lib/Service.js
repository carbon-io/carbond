...
var Service = oo({
 ...
 /******************************************************************************
  ...
  /*****************************************************************************
   * @method _initializeServiceTree
   * @description Second pass (after atom) Service initialization. This function
   *              simply serves as an entry point to _initializeEndpoint for the
   *              top-level service.
   * @returns {undefined}
   */
  _initializeServiceTree: function() {
