...
module.exports = oo({
  ...
  _C: function() {
    ...
    this.serviceEnv = 'development'
      /*
    this.cmdargs.serviceVerbosity = {
      abbr: 'v',
      metavar: 'VERBOSITY',
      property: true,
      choices: ['trace', 'debug', 'info', 'warn', 'error', 'fatal'],
      help: 'service verbosity level (trace | debug | info | warn | error | fatal)',
      required: false
    }
    */
  },
  ...
  /***************************************************************************
   * @property {Object} [serviceTestCmdargs] -- xxx
   */
  serviceTestCmdargs: {
    verbosity: {
      abbr: 'v',
  ...
  _init: function() {
    ...
    Object.assign(this.cmdargs, this.serviceTestCmdargs)
  },
  ...
  setup: function() {
    if (this.verbosity) {
      this.service.verbosity = this.verbosity
    } else if (this.suppressServiceLogging) {
