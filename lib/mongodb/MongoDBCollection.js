...
module.exports = oo({
   ...
   * @param {carbond.mongodb.MongoDBCollection.SaveObjectConfig} -- The save object operation config
  ...
  saveObject: function(object, context, options) {
    ...
    return {
      val: options.upsert ? object : result.value,
      created: options.upsert && _.isNil(result.value)
    }
  },
