...
var StaticDocumentationGenerator = oo({
  ...
  _generateOperationDescriptor: function(method, operation, path_) {
    ...
    var parameterDescriptors = self._generateParameterDescriptors(operation.parameters, inheritedParameters, path_)
    ...
    return {
      ...
      responseSchemaElements: self._generateResponseSchemaDescriptors(operation.responses),
  ...
  _generateRequestDescriptors: function(method, parameters, parameterDescriptors) {
    if (_.includes(['post', 'patch'], method)) {
      ...
      return [
        {
          parameters: parameterDescriptors,
          schema: self._removeNoDocumentProperties(request_schema)
        }
      ]
    }
