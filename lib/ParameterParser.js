...
module.exports = oo({
   ...
   * @description ParameterParser class description
   * @memberof carbond
   */
  _C: function() {
  },
   ...
   * @description processParameters
   * @param {xxx} req -- xxx
   * @param {xxx} definitions -- xxx
   ...
   * @description processParameterValue description
   * @param {xxx} datum -- xxx
   * @param {xxx} definition -- xxx
   * @returns {xxx} -- xxx
   */
   ...
   * @description parseParameterValue description
   * @param {xxx} datum -- xxx
   * @param {xxx} definition -- xxx
   * @returns {xxx} -- xxx
   */
       ...
       result = datum
        ...
        if (schema.type === 'ObjectId') {
          ...
          try {
            ...
            throw new Error(
              "Problem parsing parameter value: " + datum + " as EJSON. Reason: " + e.message)
          }
        }
      }
