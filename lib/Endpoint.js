...
module.exports = oo({
  ...
  /*****************************************************************************
   * @property {object} ALL_METHODS -- xxx
  ...
  /*****************************************************************************
   * @constructs Endpoint
   * @description Endpoint class description
   * @memberof carbond
   */
  _C: function() {
    /***************************************************************************
    ...
    /***************************************************************************
     * @property {xxx} allowUnauthenticated -- xxx
     */
    ...
    /***************************************************************************
     * @property {boolean} [noDocument=false] -- xxx
     */
   ...
   * @description _initializeParameters description
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeOperations description
   * @returns {undefined} -- undefined
   */
   ...
   * @description _initializeOperation description
   * @returns {undefined} -- undefined
   */
  ...
  /*****************************************************************************
   * @method getOperation
   * @description getOperation method description
   ...
   * @description isOperationAuthorized description
   * @param {Function} method -- xxx
   * @param {xxx} user -- xxx
   * @param {xxx} req -- xxx
   * @returns {boolean} -- xxx
   ...
   * @description supportedMethods description
   * @returns {xxx} -- xxx
   */
  ...
  /*****************************************************************************
   * @method getService
   * @description getService descroption
   ...
   * @descripton _computeFullEndpointAcl description
   * @returns {xxx} -- xxx
   */
   ...
   * _aclAndBelow
   *
   * Combines an ACL from a parent endpoint with one from its child.  If the parent
   * ACL has no selfAndBelow configured, only the child ACL is used.  If
   * selfAndBelow is true, the user must have the same permission on the parent to
   * access the child.  If selfAndBelow is the name of a permission (e.g. 'get'),
   * the user must have that permission on the parent in order to access the child.
   * If selfAndBelow is a function, it will be invoked with the user, permission
   * name, and environment as arguments just like the regular permission functions
   * in order to determine access.  Assuming the user has access to the parent as
   * defined above, the child ACL will then be evaluated.  If there is no child
   * ACL, the user is granted permission by default.
   */
