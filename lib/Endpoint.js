...
module.exports = oo({
   ...
   * @description Initializes all operations defined on this endpoint. This method
   *              will instantiate the operations using their definitions if the are
   *              not already instances of {@link carbond.OperationParameter}.
   * @returns {undefined}
   */
  ...
  /*****************************************************************************
   * @method getService
   * @description Returns the root {@link carbond.Service} object (note, this is
